...
public abstract class ClientPlayNetworkHandlerMixin {
    ...
    //TODO: Might be problems with the first 3, but unsure
    @Redirect(
        method = "onGameStateChange(Lnet/minecraft/network/packet/s2c/play/GameStateChangeS2CPacket;)V",
        at = @At(
            value = "INVOKE",
    ...
    private Vec3d wrapOperation_onExplosion_add_0(
        Vec3d vec3d, double x, double y, double z, Operation<Vec3d> original
    ) {
